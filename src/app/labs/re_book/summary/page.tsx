...
{/* <Link href={'/labs/send_details'}> */}
                  <Button onClick={handleAddToCartClick} style={{height: '3rem', width :'100%' , backgroundColor : '#AE7FD1' , color :'white' , marginTop : '24px'}} color="primary" className="btn-lg" >Reschedule<span><i className="fa fa-angle-right" style={{marginLeft:'1rem'}}></i></span></Button>
{/* </Link> */}
                </Col>
        <div>
            {/* <OpenModalMofi/> */}
