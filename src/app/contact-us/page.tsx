'use client'
import { Button, Card, CardBody, Col, Form, FormGroup, Input, Label, Row, Toast, ToastBody } from "reactstrap";
...
const toasterNotification = () => {
  setOpen(true)
        setToasterContent('Thank you for contacting us.')
  ...
  return (
    <>
      ...
      <Head>
        ...
        <title>Contact Labon | An Online Home Blood Test Booking Platform | Kerala, India</title>
      </Head>
