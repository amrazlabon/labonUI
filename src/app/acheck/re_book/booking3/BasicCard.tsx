    ...
    <Col sm="12" xl="12">
      <Card style={{backgroundColor : '#E5E5E5' , boxShadow : 'none'}}>
        ...
        <img style={{height:'25px'}} className="img-fluid table-avtar" src={`${ImagePath}/caution.png`} alt="user image" />
          ...
          Reschedule by selecting a time slot on which you want our phlebotomist to come for blood sample collection. If this test requires fasting, ensure you are on fasting for atleast 4-12 hours for accurate results.
